package com.xiyunmn.cwmhook.host

object CiweiMaoPackages {
    const val NOVEL = "com.kuangxiangciweimao.novel"
...
object CiweiMaoClasses {
    ...
    const val READER_TEXT_TYPE_ACTIVITY =
        "com.kuangxiangciweimao.novel.activity.bookshelf.reader.setting.TextTypeActivity"
    const val READER_TEXT_SETTING_LAYOUT = "com.kuangxiangciweimao.novel.widgets.reader.ReaderTextSettingLayout"
    const val COUSTM_FONT = "com.kuangxiangciweimao.novel.utils.CoustmFont"
    ...
    const val SENSORS_UTILS = "com.kuangxiangciweimao.novel.utils.SensorsUtils"
    ...
    const val CREATE_AD_TASK = "com.kuangxiangciweimao.novel.task.task.my.CreateAdTask"
    const val GET_WEEKBOX_TASK = "com.kuangxiangciweimao.novel.task.task.my.GetWeekboxTask"
    const val ALL_MISSION_LIST_TASK = "com.kuangxiangciweimao.novel.task.task.my.AllMissionListTask"
    const val PSON_HOME_PROP_TASK = "com.kuangxiangciweimao.novel.task.task.my.PsonHomePropTask"
    const val SETTINGS_MY = "com.kuangxiangciweimao.novel.common.Settings_My"
    const val MISSION_ACTIVITY = "com.kuangxiangciweimao.novel.activity.my.mission.MissionActivity"
    const val MISSION_DIALOG = "com.kuangxiangciweimao.novel.activity.my.mission.MissionDialog"
    const val MISSION_BOX_DATA = "com.kuangxiangciweimao.novel.task.data.my.task.MissionBoxData"
    const val PUSH_HELPER = "com.kuangxiangciweimao.novel.push.PushHelper"
    const val WEB_ACTIVITY = "com.kuangxiangciweimao.novel.activity.web.WebActivity"
    const val WM_REWARD_AD = "com.windmill.sdk.reward.WMRewardAd"
    const val WM_REWARD_INFO = "com.windmill.sdk.reward.WMRewardInfo"
    const val WM_AD_INFO = "com.windmill.sdk.models.AdInfo"
    const val SKIN_CHANGE_HELPER = "com.kuangxiangciweimao.skin.helper.SkinChangeHelper"
    const val SKIN_CHANGE_LISTENER = "com.kuangxiangciweimao.skin.helper.SkinChangeHelper\$OnSkinChangeListener"
    const val BOOK_SHELF_FRAGMENT = "com.kuangxiangciweimao.novel.activity.bookshelf.newbookshelf.BookShelfFrgment1"
    ...
    const val BOOK_INFO_TOP_LAYOUT = "com.kuangxiangciweimao.novel.activity.bookshelf.detail.BookInfoTopLayout"
